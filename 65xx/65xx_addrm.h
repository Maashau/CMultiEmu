...
static inline U8 addrm_read8(Processor_65xx * pProcessor, mos65xx_addr address);
static inline U16 addrm_read16(Processor_65xx * pProcessor, mos65xx_addr address);
static inline void addrm_write8(Processor_65xx * pProcessor, mos65xx_addr address, U8 value);
static inline void addrm_write16(Processor_65xx * pProcessor, mos65xx_addr address, U16 value);
...
*******************************************************************************/
static inline mos65xx_addr addrm_IMM(
...
*******************************************************************************/
static inline mos65xx_addr addrm_REL(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_ABS(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_ABX(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_ABY(
	Processor_65xx *	pProcessor
) {	
...
*******************************************************************************/
static inline mos65xx_addr addrm_ZPG(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_ZPX(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_ZPY(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_IND(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_INX(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline mos65xx_addr addrm_INY(
	Processor_65xx *	pProcessor
) {
...
*******************************************************************************/
static inline U8 addrm_stackPop8(Processor_65xx * pProcessor) {
	pProcessor->reg.SP++;
...
*******************************************************************************/
static inline U16 addrm_stackPop16(Processor_65xx * pProcessor) {
	U16 readValue;
	pProcessor->reg.SP++;
...
*******************************************************************************/
static inline void addrm_stackPush8(Processor_65xx * pProcessor, U8 value) {
...
*******************************************************************************/
static inline void addrm_stackPush16(Processor_65xx * pProcessor, U16 value) {
	pProcessor->reg.SP--;
